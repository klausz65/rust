...
//~^ ERROR associated type bound for `Assoc` in `dyn Fixed` differs from associated type bound implied by supertrait
...
//~^ ERROR associated type bound for `Assoc2` in `dyn FixedGeneric1` differs from associated type bound implied by supertrait
