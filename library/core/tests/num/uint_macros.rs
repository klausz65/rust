    ...
    ($T:ident) => {
        ...
        test_runtime_and_compiletime! {
            ...
            fn test_carrying2_mul() {
                assert_eq_const_safe!($T::MAX.carrying2_mul($T::MAX, 0, 0), (1, $T::MAX - 1));
                assert_eq_const_safe!($T::MAX.carrying2_mul($T::MAX, $T::MAX, 0), (0, $T::MAX));
                assert_eq_const_safe!($T::MAX.carrying2_mul($T::MAX, $T::MAX, $T::MAX), ($T::MAX, $T::MAX));
            }
