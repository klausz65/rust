    ...
    ($T:ident, $U:ident) => {
        ...
        test_runtime_and_compiletime! {
            ...
            fn test_carrying2_mul() {
                assert_eq_const_safe!(MAX.carrying2_mul(MAX, 0, 0), (1, MAX / 2));
                assert_eq_const_safe!(
                    MAX.carrying2_mul(MAX, MAX, 0),
                    (UMAX / 2 + 1, MAX / 2)
                );
                assert_eq_const_safe!(
                    MAX.carrying2_mul(MAX, MIN, 0),
                    (UMAX / 2 + 2, MAX / 2 - 1)
                );
                assert_eq_const_safe!(
                    MAX.carrying2_mul(MAX, MAX, MAX),
                    (UMAX, MAX / 2)
                );
                assert_eq_const_safe!(
                    MAX.carrying2_mul(MAX, MAX, MIN),
                    (0, MAX / 2)
                );
                assert_eq_const_safe!(
                    MAX.carrying2_mul(MAX, MIN, MIN),
                    (1, MAX / 2 - 1)
                );
                assert_eq_const_safe!(
                    MIN.carrying2_mul(MAX, 0, 0),
                    (MIN as $U, MIN / 2)
                );
                assert_eq_const_safe!(
                    MIN.carrying2_mul(MAX, MAX, 0),
                    (UMAX, MIN / 2)
                );
                assert_eq_const_safe!(MIN.carrying2_mul(MAX, MIN, 0), (0, MIN / 2));
                assert_eq_const_safe!(
                    MIN.carrying2_mul(MAX, MAX, MAX),
                    (UMAX / 2 - 1, MIN / 2 + 1)
                );
                assert_eq_const_safe!(
                    MIN.carrying2_mul(MAX, MAX, MIN),
                    (UMAX / 2, MIN / 2)
                );
                assert_eq_const_safe!(
                    MIN.carrying2_mul(MAX, MIN, MIN),
                    (UMAX / 2 + 1, MIN / 2 - 1)
                );
                assert_eq_const_safe!(MIN.carrying2_mul(MIN, 0, 0), (0, MAX / 2 + 1));
                assert_eq_const_safe!(
                    MIN.carrying2_mul(MIN, MAX, 0),
                    (UMAX / 2, MAX / 2 + 1)
                );
                assert_eq_const_safe!(
                    MIN.carrying2_mul(MIN, MIN, 0),
                    (UMAX / 2 + 1, MAX / 2)
                );
                assert_eq_const_safe!(
                    MIN.carrying2_mul(MIN, MAX, MAX),
                    (UMAX - 1, MAX / 2 + 1)
                );
                assert_eq_const_safe!(
                    MIN.carrying2_mul(MIN, MAX, MIN),
                    (UMAX, MAX / 2)
                );
                assert_eq_const_safe!(
                    MIN.carrying2_mul(MIN, MIN, MIN),
                    (0, MAX / 2)
                );
            }
