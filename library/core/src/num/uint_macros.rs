macro_rules! uint_impl {
    (
        ...
        #[cfg_attr(not(bootstrap), doc = concat!("assert_eq!(",
            stringify!($SelfT), "::MAX.carrying_mul(", stringify!($SelfT), "::MAX, ", stringify!($SelfT), "::MAX), ",
            "(0, ", stringify!($SelfT), "::MAX));"
        ))]
        /// ```
        ///
        /// This is a core operation needed for scalar multiplication when
        ...
        /// ```
        /// #![feature(bigint_helper_methods)]
        /// assert_eq!(5u32.carrying2_mul(2, 0, 0), (10, 0));
        /// assert_eq!(5u32.carrying2_mul(2, 10, 10), (30, 0));
        /// assert_eq!(1_000_000_000u32.carrying2_mul(10, 0, 0), (1410065408, 2));
        /// assert_eq!(1_000_000_000u32.carrying2_mul(10, 10, 10), (1410065428, 2));
        ...
        #[rustc_allow_const_fn_unstable(const_bigint_helper_methods)]
        #[inline]
        pub const fn carrying2_mul(self, rhs: Self, carry1: Self, carry2: Self) -> (Self, Self) {
